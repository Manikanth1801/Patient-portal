...
export class TimelineResource extends SampleBase {
    constructor() {
        ...
        this.ownerData = [
            { text: 'Dr Bhanu', id: 1, color: '#ea7a57', capacity: 20, type: 'Emergency' },
            { text: 'Dr Shanu', id: 2, color: '#7fa900', capacity: 7, type: 'Nero' },
            { text: 'Dr Uppal', id: 3, color: '#5978ee', capacity: 5, type: 'Gyno' },
            { text: 'Dr Pavan', id: 4, color: '#fec200', capacity: 15, type: 'Cardio' },
            { text: 'Dr Chaitu', id: 5, color: '#df5286', capacity: 25, type: 'Medicene' },
            { text: 'Dr Pankaj', id: 6, color: '#00bdae', capacity: 10, type: 'Gyno' },
            { text: 'Dr Manii', id: 7, color: '#865fcf', capacity: 20, type: 'Mallogy' },
            { text: 'Dr Sidd', id: 8, color: '#1aaa55', capacity: 8, type: 'Pallogy' },
            { text: 'Dr Adii', id: 9, color: '#df5286', capacity: 30, type: 'Sallogy' },
            { text: 'Dr Sushma', id: 10, color: '#710193', capacity: 25, type: 'Challojy' }
        ];
    }
    getRoomName(value) {
